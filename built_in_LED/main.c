...
int main(void) {
  // 1. Enable the clock for GPIOA in the RCC AHB1 peripheral clock enable
  // register.
  ...
  //    The GPIOA_MODER register controls the mode for each pin. Two bits are
  //    used per pin. For PA5, we need to configure bits 11 and 10.
  //    - 00: Input (reset state)
  //    - 01: General purpose output mode
  //    - 10: Alternate function mode
  //    - 11: Analog mode
  //    We want to set it to '01'. First, we clear bits 11 and 10, then set
  //    bit 10.
